...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            readData("articles_1000.train", tokens, ids);
            Map<Integer, Integer> matches = readGroundTruth("articles_1000.truth", ids);

            long start = System.currentTimeMillis();
            // ToDo
            DuplicateFinder df = new JaccardIndexDuplicateFinder(tokens);
